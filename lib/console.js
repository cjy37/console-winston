...
module.exports = function(level) {
  ...
  var _silly = console.silly;
  var _debug = console.debug;
  var _log = console.log;
  var _verbose = console.verbose;
  ...
  console.silly = function(){
    _silly.apply(console, processArgs('silly', arguments));
  };
  console.debug = function(){
    _debug.apply(console, processArgs('debug', arguments));
  };
  console.log = function(){
    _debug.apply(console, processArgs('debug', arguments));
  };
  console.verbose = function(){
    _verbose.apply(console, processArgs('verbose', arguments));
  };
